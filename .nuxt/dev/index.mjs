import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getCookie, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import _RemarkEmoji from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/remark-emoji/index.js';
import { createStorage, prefixStorage } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/unstorage/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/ufo/dist/index.mjs';
...
import { isAbsolute, extname } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/micromark-util-sanitize-uri/dev/index.js';
...
import destr, { destr as destr$1 } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/destr/dist/index.mjs';
import slugify from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/slugify/slugify.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/@unhead/ssr/dist/index.mjs';
...
import { consola } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/vue/index.mjs';
...
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/kairos/Documents/GitHub/Chronos/node_modules/@unhead/shared/dist/index.mjs';
...
const _jhXdu1OqH4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/kairos/Documents/GitHub/Chronos";
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/kairos/Documents/GitHub/Chronos/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kairos/Documents/GitHub/Chronos/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/kairos/Documents/GitHub/Chronos","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/kairos/Documents/GitHub/Chronos/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/kairos/Documents/GitHub/Chronos/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/kairos/Documents/GitHub/Chronos/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kairos/Documents/GitHub/Chronos/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _VHvMT4ZzeW = defineNitroPlugin(async (nitro) => {
...
const _lazy_Fv3gVh = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Fv3gVh, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/_content/cache.json', handler: _1drnOx, lazy: false, middleware: false, method: "get" },
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/kairos/Documents/GitHub/Chronos/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const getClientManifest = () => import('file:///Users/kairos/Documents/GitHub/Chronos/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/kairos/Documents/GitHub/Chronos/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
